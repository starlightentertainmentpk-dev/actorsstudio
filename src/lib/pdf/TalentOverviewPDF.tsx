...
export interface TalentOverviewPDFProps {
  talent: any
}

export function TalentOverviewPDF({ talent }: TalentOverviewPDFProps) {
  ...
  return (
    <Document title={`${displayName} - Overview & Bio`}>
      <Page size="A4" orientation="portrait" style={styles.page}>
        {/* Header */}
        <View style={styles.header}>
          <View style={styles.brandRow}>
            <Text style={styles.brandTitle}>Actor's Studio</Text>
            <Text style={styles.brandSubtitle}>Executive Talent Overview & Bio</Text>
          </View>
        ...
        <View style={styles.footer}>
          ...
          <Text style={styles.footerText}>
            {talent.slug ? `actorsstudio.pk/talent/${talent.slug}` : 'actorsstudio.pk'} • Printed on {new Date().toLocaleDateString('en-GB')}
          </Text>
        </View>
      </Page>
    </Document>
