...
export default function CastingDashboardPage() {
  const { user, isLoading } = useRequireAuth("casting_director")
      ...
      <div className="space-y-6">
        ...
        <div className="border border-border/40 bg-card/20 rounded-xl p-6">
          <p className="text-sm text-foreground">
            This is the Casting Director dashboard workspace. Here you can run talent search, create new casting calls, review incoming applications, and coordinate auditions.
          </p>
        </div>
      </div>
    </DashboardShell>
